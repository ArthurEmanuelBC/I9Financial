...
class MakeView
{
    ...
    protected function replaceSchemaIndex(&$stub)
    {
        ...
        // Create view index search fields
        $schema = (new SyntaxBuilder)->create($this->schemaArray, $this->scaffoldCommandObj->getMeta(), 'view-index-search');
        $stub = str_replace('{{search_fields}}', $schema, $stub);
     ...
     * @return $this
     */
    private function replaceSchemaForm(&$stub)
    {


        // Create view index content fields
        $schema = (new SyntaxBuilder)->create($this->schemaArray, $this->scaffoldCommandObj->getMeta(), 'view-form-content', $this->scaffoldCommandObj->option('form'));
        $stub = str_replace('{{content_fields}}', $schema, $stub);
