...
<div class="templatemo-content-widget white-bg">
    ...
    <div class="row form-group">
        ...
        <div id="row_pagador" class="row form-group hide">
            <div class="col-md-8">
                {!! Html::decode(Form::label('pagador_nome', 'Nome do Pagador <span class="obrigatorio">*</span>', ['class' => 'control-label'])) !!}
                {!! Form::text('pagador_nome', @$paciente->pagador()->nome, ['class' => 'form-control','required' => $paciente->pagador_id]) !!}
            </div>
            <div class="col-md-4">
                {!! Html::decode(Form::label('pagador_cpf', 'CPF do Pagador <span class="obrigatorio">*</span>', ['class' => 'control-label'])) !!}
                {!! Form::text('pagador_cpf', @$paciente->pagador()->cpf, ['class' => 'form-control cpf','required' => $paciente->pagador_id]) !!}
            </div>
        </div>
