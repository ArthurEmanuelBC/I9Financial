...
<head>
	...
	<body>  
			...
			<div class="templatemo-sidebar">
				...
				<nav class="templatemo-left-nav">
					<ul>
						...
						<li><a href="/pacientes" class="<?php if(Request::is('pacientes*')): ?> active <?php endif; ?>"><i class="fa fa-user fa-fw"></i>Pacientes</a></li>
						<li><a href="/empresas" class="<?php if(Request::is('empresas*')): ?> active <?php endif; ?>"><i class="fa fa-briefcase fa-fw"></i>Empresas</a></li>
						<li><a href="/parcelas" class="<?php if(Request::is('parcelas*')): ?> active <?php endif; ?>"><i class="fa fa-dollar fa-fw"></i>Fluxo de Caixa</a></li>
						<li><a href="/contas?tipo=0" class="<?php if(Request::is('contas*') && @$tipo == '0'): ?> active <?php endif; ?>"><i class="fa fa-mail-forward fa-fw"></i>Contas a Pagar</a></li>
						<li><a href="/contas?tipo=1" class="<?php if(Request::is('contas*') && @$tipo == '1'): ?> active <?php endif; ?>"><i class="fa fa-mail-reply fa-fw"></i>Contas a Receber</a></li>
					...
					<div class="row">
						<nav class="templatemo-top-nav col-lg-8 col-md-8 col-xs-12 form-group">
							<ul class="text-uppercase">
								<li><a href="<?php echo e(route('users.edit', ['id' => Auth::user()->id, 'config' => 'true'])); ?>" <?php if(!empty($config)): ?>class="active" <?php endif; ?>>Configurações</a></li>
		...
		<?php if(Request::is('lancamentos*')): ?> <script type="text/javascript">$('.submenu.lancamentos > a').trigger( "click" );</script> <?php endif; ?>
