...
<div class="templatemo-content-widget white-bg">
  ...
  <div class="row form-group">
    ...
    <div class="col-md-4 col-sm-12 col-xs-12">
      <?php echo Html::decode(Form::label('cpf', 'CPF', ['class' => 'control-label'])); ?>

      <?php echo Form::text('cpf', $paciente->cpf, ['class' => 'form-control']); ?>
  ...
  <div id="row_pagador" class="row form-group hide">
    <div class="col-md-8">
      <?php echo Html::decode(Form::label('pagador_nome', 'Nome do Pagador <span class="obrigatorio">*</span>', ['class'
      => 'control-label'])); ?>

      <?php echo Form::text('pagador_nome', @$paciente->pagador()->nome, ['class' => 'form-control','required' =>
      $paciente->pagador_id]); ?>

    </div>
    <div class="col-md-4">
      <?php echo Html::decode(Form::label('pagador_cpf', 'CPF do Pagador <span class="obrigatorio">*</span>', ['class' =>
      'control-label'])); ?>

      <?php echo Form::text('pagador_cpf', @$paciente->pagador()->cpf, ['class' => 'form-control cpf','required' =>
      $paciente->pagador_id]); ?>
  ...
  <div class="form-group text-right">
    ...
    <a class="templatemo-white-button" href="<?php echo e(route('pacientes.index')); ?>"><i class="fa fa-arrow-left"></i>
      Voltar</a>
  </div>
  <?php echo Form::close(); ?>
