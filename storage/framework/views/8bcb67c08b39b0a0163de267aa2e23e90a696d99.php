...
<div class="templatemo-content-widget white-bg">
    ...
    <?php echo Form::open(['route' => [$url, $empresa->id], 'method' => $method, 'class' => 'form-horizontal', 'enctype' =>
    'multipart/form-data']); ?>

    <div class="row form-group">
        <div class="col-md-6 col-sm-12 col-xs-12">
            <?php echo Html::decode(Form::label('nome', 'Nome <span class="obrigatorio">*</span>', ['class' =>
            'control-label'])); ?>
    ...
    <div class="row form-group">
        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
            <?php echo Html::decode(Form::label('logradouro', 'Logradouro <span class="obrigatorio">*</span>', ['class' =>
            'control-label'])); ?>
    ...
    <div class="row form-group">
        <div class="col-md-4 col-sm-12 col-xs-12">
            <?php echo Html::decode(Form::label('bairro', 'Bairro <span class="obrigatorio">*</span>', ['class' =>
            'control-label'])); ?>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
            <?php echo Html::decode(Form::label('cidade', 'Cidade <span class="obrigatorio">*</span>', ['class' =>
            'control-label'])); ?>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
            <?php echo Html::decode(Form::label('estado', 'Estado <span class="obrigatorio">*</span>', ['class' =>
            'control-label'])); ?>
    ...
    <div class="row form-group">
        <div class="col-md-4 col-sm-12 col-xs-12">
            <?php echo Html::decode(Form::label('numero', 'Número <span class="obrigatorio">*</span>', ['class' =>
            'control-label'])); ?>
    ...
    <div class="row form-group">
        <div class="col-md-4 col-sm-12 col-xs-12">
            <?php echo Html::decode(Form::label('telefone', 'Telefone <span class="obrigatorio">*</span>', ['class' =>
            'control-label'])); ?>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
            <?php echo Html::decode(Form::label('margem', 'Margem Mensal <span class="obrigatorio">*</span>', ['class' =>
            'control-label'])); ?>

            <?php if($method == 'post'): ?> <?php echo Form::text('margem', NULL, ['class' => 'form-control margem','onKeyDown' =>
            'Formata(this,20,event,2)', 'required' => 'true']); ?> <?php else: ?> <?php echo Form::text('margem',
            number_format($empresa->margem,2,',','.'), ['class' => 'form-control', 'onKeyDown' =>
    ...
    <div class="form-group text-right">
        ...
        <a class="templatemo-white-button" href="<?php echo e(route('empresas.index')); ?>"><i class="fa fa-arrow-left"></i>
            Voltar</a>
    </div>
    <?php echo Form::close(); ?>
