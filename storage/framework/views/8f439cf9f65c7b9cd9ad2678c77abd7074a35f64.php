			...
			<div class="templatemo-sidebar">
				...
				<nav class="templatemo-left-nav">
					<ul>
						...
						<li><a href="/users" class="<?php if(Request::is('users*')): ?> active <?php endif; ?>"><i class="fa fa-user fa-fw"></i>Usuários</a></li>
						<li><a href="/pacientes" class="<?php if(Request::is('pacientes*')): ?> active <?php endif; ?>"><i class="fa fa-users fa-fw"></i>Pacientes</a></li>
						<li><a href="/empresas" class="<?php if(Request::is('empresas*')): ?> active <?php endif; ?>"><i class="fa fa-briefcase fa-fw"></i>Médicos</a></li>
						<li><a href="/contas?tipo=0" class="<?php if(Request::is('contas*') && @$tipo == '0'): ?> active <?php endif; ?>"><i class="fa fa-mail-forward fa-fw"></i>Receita</a></li>
						<li><a href="/contas?tipo=1" class="<?php if(Request::is('contas*') && @$tipo == '1'): ?> active <?php endif; ?>"><i class="fa fa-mail-reply fa-fw"></i>Despesa</a></li>
